...
# Tyring to create a graph with:
#- X-axis: instruction from the PC, in order of PC (or first exec?), Y-axis: the number of cycles loaded data has been critical.
# Might gets a little tricky for the lines that load multiple lines
...
# get the program counter from 'address' in ls_inst
# This currently goes through the valid cache lines... but could be valid due to multiple instructions? Or related to a single instruction... I wish I had documented this schema better.
